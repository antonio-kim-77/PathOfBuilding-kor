  ...
  controls.mainSocketGroup:CheckDroppedWidth(true)
	...
	if #controls.mainSocketGroup.list == 0 then
		...
		for i, activeSkill in ipairs(displaySkillList) do
			...
			t_insert(controls.mainSkill.list, { val = i, label = colourCoded or activeSkill.activeEffect.grantedEffect.korName or activeSkill.activeEffect.grantedEffect.name })
		end
