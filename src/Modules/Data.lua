...
data.powerStatList = {
	{ stat=nil, label="공격/방어", combinedOffDef=true, ignoreForItems=true },
	...
	{ stat="FullDPS", label="전체 DPS" },
	{ stat="CombinedDPS", label="합산 DPS" },
	{ stat="TotalDPS", label="적중 DPS" },
	{ stat="WithImpaleDPS", label="관통 + 적중 DPS" },
	{ stat="AverageDamage", label="평균 적중" },
	{ stat="Speed", label="공격/시전 속도" },
	{ stat="TotalDot", label="DoT DPS" },
	{ stat="BleedDPS", label="출혈 DPS" },
	{ stat="IgniteDPS", label="점화 DPS" },
	{ stat="PoisonDPS", label="중독 DPS" },
	{ stat="Life", label="생명력" },
	{ stat="LifeRegen", label="생명력 재생" },
	{ stat="LifeLeechRate", label="생명력 흡수" },
	{ stat="Armour", label="방어도" },
	{ stat="Evasion", label="회피" },
	{ stat="EnergyShield", label="에너지 보호막" },
	{ stat="EnergyShieldRecoveryCap", label="회복 가능 ES" },
	{ stat="EnergyShieldRegen", label="에너지 보호막 재생" },
	{ stat="EnergyShieldLeechRate", label="에너지 보호막 흡수" },
	{ stat="Mana", label="마나" },
	{ stat="ManaRegen", label="마나 재생" },
	{ stat="ManaLeechRate", label="마나 흡수" },
	{ stat="Ward", label="보호구" },
	{ stat="Str", label="힘" },
	{ stat="Dex", label="민첩" },
	{ stat="Int", label="지능" },
	{ stat="TotalAttr", label="총 능력치" },
	{ stat="MeleeAvoidChance", label="근접 회피 확률" },
	{ stat="SpellAvoidChance", label="주문 회피 확률" },
	{ stat="ProjectileAvoidChance", label="투사체 회피 확률" },
	{ stat="TotalEHP", label="유효 타격 풀" },
	{ stat="SecondMinimalMaximumHitTaken", label="유효 최대 피격" },
	{ stat="PhysicalTakenHit", label="받는 물리 피해", transform=function(value) return -value end },
	{ stat="LightningTakenHit", label="받는 번개 피해", transform=function(value) return -value end },
	{ stat="ColdTakenHit", label="받는 냉기 피해", transform=function(value) return -value end },
	{ stat="FireTakenHit", label="받는 화염 피해", transform=function(value) return -value end },
	{ stat="ChaosTakenHit", label="받는 카오스 피해", transform=function(value) return -value end },
	{ stat="CritChance", label="치명타 확률" },
	{ stat="CritMultiplier", label="치명타 배율" },
	{ stat="BleedChance", label="출혈 확률" },
	{ stat="FreezeChance", label="동결 확률" },
	{ stat="IgniteChance", label="점화 확률" },
	{ stat="ShockChance", label="감전 확률" },
	{ stat="EffectiveMovementSpeedMod", label="이동 속도" },
	{ stat="BlockChance", label="막기 확률" },
	{ stat="SpellBlockChance", label="주문 막기 확률" },
	{ stat="SpellSuppressionChance", label="주문 억제 확률" },
}
...
data.enchantmentSource = {
	{ name = "ENKINDLING", label = "점화의 오브" },
	{ name = "INSTILLING", label = "주입의 오브" },
	{ name = "RUNESMITH", label = "룬제작 작업대" },
	{ name = "HEIST", label = "하이스트" },
	{ name = "HARVEST", label = "수확" },
	{ name = "DEDICATION", label = "여신에의 헌신" },
	{ name = "ENDGAME", label = "영원의 미궁" },
	{ name = "MERCILESS", label = "무자비의 미궁" },
	{ name = "CRUEL", label = "잔혹의 미궁" },
	{ name = "NORMAL", label = "일반 미궁" },
}
